...
from .datamodels import CritterMeta, LogLine, OverviewTableRow, TreeItem, TreeModel
from .detection import Detection
from .utilities import get_entity_name, get_player_handle, datetime_to_display


def check_difficulty_deaths(difficulty_data: dict, combat_meta: dict[str, CritterMeta]) -> bool:
    """
...
def check_difficulty_damage(difficulty_data: dict, combat_meta: dict[str, CritterMeta]) -> bool:
    """
